...
export default {
    data() {
        return {
            ...
            packName: this.$route.query.packName || '', // Recibe el nombre del tour
            ...
            price_agencia: this.$route.query.price || 0, // Precio de agencia
    ...
    methods: {
        ...
        goToReservation() {
            ...
            const formData = {
                ...
                booking_type: 'pack' // o 'hotel', 'experiencia', según el caso
            };
